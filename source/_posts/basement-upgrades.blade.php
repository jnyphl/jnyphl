...
@section ('content')
    ...
    <img src='/assets/images/2018-03-01-basement-upgrades/radon-02.png' class="block">
    Before we closed on the house, the seller allowed me to set out some radon test kits in the basement. The tests reported the level at 11.2pCi/l (picocuries per litre of air) which is above the EPA states as safe. We hired a contractor to install a <a href='https://www.michigan.gov/deq/0,4561,7-135-3312_4120_4196-485693--,00.html'>radon mitigation system</a>. The total cost of was ~$800 and a few hours of my own time. Realistically, the cost is irrelevant due to the protection the system offers my family over the course of our lives. Looking back on the install job, I would have changed a few things and will write another blog post about that.</p>
    <p>Everyone who is willing and able can and should install a radon mitigation system. Read your local and state building codes and you can most likely do it yourself.</p>
    ...
    <div class="flex flex-wrap -mx-4 mt-6">
        <div class="px-4 mb-8 w-1/2">
            <img src="/assets/images/2018-03-01-basement-upgrades/backup-to-the-backup.jpg">
            <p class="my-2">In the event that our powered sump pump fails, we have a backup ready to go.</p>
        </div>
        <div class="px-4 mb-8 w-1/2">
            <img src="/assets/images/2018-03-01-basement-upgrades/planning-backup-sump-pump.jpg">
            <p class="my-2">The area we'll be working in. IRL it's less of a mess than it looks.</p>
        </div>
        <div class="px-4 mb-8 w-1/2">
            <img src="/assets/images/2018-03-01-basement-upgrades/backup-water-line.jpg">
            <p class="my-2">Noting the location of the water line coming off the main.</p>
        </div>
        <div class="px-4 mb-8 w-1/2">
            <img src="/assets/images/2018-03-01-basement-upgrades/dad-helping.jpg">
            <p class="my-2">My dad holding the water main powered backup sump pump.</p>
        </div>
        <div class="px-4 mb-8 w-1/2">
            <img src="/assets/images/2018-03-01-basement-upgrades/backup-sump-pump.jpg">
            <p class="my-2">Final installation of the water main powered sump pump. We installed a ball valve to turn it on/off when we leave for trips.</p>
        </div>
        <div class="px-4 mb-8 w-1/2">
            <img src="/assets/images/2018-03-01-basement-upgrades/this-thing-sucks.jpg">
            <p class="my-2">This thing sucks. I had figured that the sump pump would continue to operate normally in addition to firing the alarm and turning on once water touched a certain point.</p>
        </div>
        <div class="px-4 mb-8 w-1/2">
            <img src="/assets/images/2018-03-01-basement-upgrades/furnace-pre-work.jpg">
            <p class="my-2">I removed the drywall panels to allow access to the furnace.</p>
        </div>
        <div class="px-4 mb-8 w-1/2">
